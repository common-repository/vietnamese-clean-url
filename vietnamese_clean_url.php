...
/*
Plugin Name: Vietnamese Clean URL
...
Version: 1.0
Tags: nice permalink, nice slug, permalink in vietnamese, vietnamese, vietnamese slug, duong dan tieng viet, tieng viet, url, nice url
Author URI: https://vietdex.net
Donate link: https://vietdex.net
*/


function vd_remove_vnm($string) {
  $trans = array(
	/*
		special char
	*/
...
add_filter('sanitize_title', 'vd_remove_vnm', 1);
